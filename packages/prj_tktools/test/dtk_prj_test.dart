...
Future<void> main() async {
  group('dtk', () {
    ...
    test(
      'addAllProjectsToWorkspace skips sub-workspace and its tree',
      () async {
        var topDir = join(
          '.dart_tool',
          'tekartik_prj_tktools',
